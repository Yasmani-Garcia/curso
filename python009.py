...
jugadores3 = list(('Diaz','Caicedo','Scholes'))

#funcion len() para imprimir cantidad de elemento de la lista
print(len(jugadores)) #[]-->0
print(len(jugadores2)) #3
print(len(jugadores3))#3

#Para conocer el tipo de la lista
print(type(jugadores))#clase list

#Como colocar el dato de una lista
print(jugadores2[3][1])

#Seleccion por rango
print(jugadores2[0:3])

#Cambio de valores en lista
jugadores2[0] = 'Salah'
print(jugadores2)
...
#Agregar un elemento al finla de la lista
